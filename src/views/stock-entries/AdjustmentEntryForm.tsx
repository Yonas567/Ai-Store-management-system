  ...
  const handleChange = (field: string, value: any) => {
    setFormData((prev: any) => {
      ...
      if (field === "paymentMethod") {
        ...
        field === "amountPaid" &&
        updated.paymentMethod === "full_cash"
      ) {
        // Full cash payment
        ...
        updated.paymentMethod === "half_product_half_cash"
      ) {
        ...
        updated.paymentMethod === "full_product_return"
      ) {
      ...
      {formData.paymentMethod === "full_product_return" && (
        <>
          ...
          <TextField
            ...
            InputProps={{
              endAdornment: (
                <Typography sx={{ ml: 1 }}>{entry.unit}</Typography>
              ),
            }}
            required
          ...
          <TextField
            ...
            value={
              formData.returnQuantity
                ? (
                    parseFloat(formData.returnQuantity) *
                    parseFloat(entry.unitPrice)
                  ).toFixed(2)
                : ""
            }
            InputProps={{
      ...
      {formData.paymentMethod === "half_product_half_cash" && (
        <>
          ...
          <TextField
            ...
            onChange={(e) =>
              handleChange("productReturnAmount", e.target.value)
            }
            InputProps={{
              startAdornment: <Typography sx={{ mr: 1 }}>$</Typography>,
            }}
